  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
        <div className="p-6 rounded-2xl bg-white border border-slate-100 shadow-sm flex items-center justify-between hover:border-violet-300 transition-all group">
          <div className="space-y-1">
            <span className="text-xs text-slate-500 font-bold uppercase tracking-wider block">{t('dashboard.stats.total')}</span>
            <span className="text-3xl font-extrabold text-slate-900 block">{stats?.totalGenerations || 0}</span>
          </div>
          <div className="h-12 w-12 rounded-xl bg-violet-50 flex items-center justify-center text-violet-600 group-hover:scale-105 transition-transform shrink-0">
            <Sparkles size={20} />
          </div>
        </div>

        <div className="p-6 rounded-2xl bg-white border border-slate-100 shadow-sm flex items-center justify-between hover:border-indigo-300 transition-all group">
          <div className="space-y-1">
            <span className="text-xs text-slate-500 font-bold uppercase tracking-wider block">{t('dashboard.stats.refinements')}</span>
            <span className="text-3xl font-extrabold text-slate-900 block">{stats?.totalRefinements || 0}</span>
          </div>
          <div className="h-12 w-12 rounded-xl bg-indigo-50 flex items-center justify-center text-indigo-600 group-hover:scale-105 transition-transform shrink-0">
            <Sliders size={20} />
          </div>
        </div>
        ...
        <div className="p-6 rounded-2xl bg-white border border-slate-100 shadow-sm flex items-center justify-between hover:border-violet-300 transition-all group">
          <div className="space-y-1">
            ...
            <span className="text-3xl font-extrabold text-slate-900 block">{stats?.activeDrafts || 0}</span>
          </div>
          <div className="h-12 w-12 rounded-xl bg-violet-50 flex items-center justify-center text-violet-600 group-hover:scale-105 transition-transform shrink-0">
            <History size={20} />
          </div>
        ...
        <div className="p-6 rounded-2xl bg-white border border-slate-100 shadow-sm flex items-center justify-between hover:border-indigo-300 transition-all group">
          <div className="space-y-1">
            ...
            <span className="text-3xl font-extrabold text-slate-900 block">{stats?.favoriteTemplates || 0}</span>
          </div>
          <div className="h-12 w-12 rounded-xl bg-indigo-50 flex items-center justify-center text-indigo-600 group-hover:scale-105 transition-transform shrink-0">
            <Bookmark size={20} />
          </div>
